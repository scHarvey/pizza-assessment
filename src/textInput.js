...
export class TextInput extends Component {
    ...
    handleTextInput (e, _this) {
        const textValue = ReactDOM.findDOMNode(_this.refs.textInput);
        _this.props.callback(textValue.value);
    }
    render() {
        return (
            <form style={{display: 'inline'}}>
                <input ref="textInput" id="TextInput" type="text" placeholder={this.props.placeholder} onKeyUp={(e) => this.handleTextInput(e, this)} />
            </form>
        );
    }
}
